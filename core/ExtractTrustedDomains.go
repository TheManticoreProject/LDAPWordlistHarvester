...
// ExtractTrustedDomains extracts the trusted domains from the LDAP server.
// It uses the ldap.Session to query the LDAP server and get the trusted domains.
// It then adds the trusted domains to the wordlist.
func ExtractTrustedDomains(ldapSession ldap.Session, wordlist *Wordlist) {
	logger.Info("Extracting trusted domains from LDAP...")
